<%-- 
    Document   : menu
    Created on : Oct 15, 2016, 1:18:50 PM
    Author     : HP
--%>
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Nam online Shopping cart</title>
...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    <a class="brand" href="index.jsp"><img src="themes/images/logo.png" alt="Bootsshop"/></a>
		<form class="form-inline navbar-search" method="post" action="quanlysanpham.htm" >
		<input id="srchFld" class="srchTxt" type="text" />
		<button type="submit" id="submitButton" class="btn btn-primary">Go</button>
    </form>
    <ul id="topMenu" class="nav pull-right">
     <li class=""><a href="index.htm">Home</a></li>
      <li class=""><a href="quanlysanpham.htm">Products</a></li>
      <li class=""><a href="customers.jsp">Customers</a></li>
...
<div id="mainBody">
	...
	<div class="row">
<!-- Sidebar ================================================== -->
	<div id="sidebar" class="span3"><br/><br/><br/>
	</div>
<!-- Sidebar end=============================================== -->	

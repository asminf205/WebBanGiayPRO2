				...
				<form action="${pageContext.request.contextPath}/suasanpham">
					...
					<ul>
					 ...
					 <ul>
						...
						<li><input type="file" id="upload" name="image" style="display:none" onchange="readURL(this)">
							<input type="button" onclick="activateUpload()" value="upload"/>
							<input type="text" id="photo" name="hinh"/>
